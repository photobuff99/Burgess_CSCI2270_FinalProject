...
<h2>How to Run</h2>
<h3> Linux </h3>
<p>Download GLFW from the website. Type "sudo apt-get update" on the terminal. Then type "sudo apt-get install cmake xorg-dev libglu1-mesa-dev" on the terminal. Navigate to GLFW folder. Then type "cmake -G "Unix Makefiles"". Then type "make" and then "sudo make install". Then download the game. Then run the makefile of the game where you have the game downloaded by typing "make". This compiles the game. Then run the executable ("./expGame") </p>
<h3> MAC OSX </h3>
