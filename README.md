...
3. g++ -o expGame main.o Graph.o -I/usr/local/include/GL -L/usr/local/lib -I/usr/local/include/GLFW -L/usr/local/lib -lGLFW -L/system/Library/Frameworks -framework OpenGL 
